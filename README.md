...
**35 правил** - стандарты кода BSL, антипаттерны, оптимизация запросов, паттерны расширений, генерация форм, требования EDT, БСП API и переиспользование БСП, права ролей, прямой запрос в отчётах, безопасная запись BSL-модулей, Python-first интеграции, двухпроходный СКД, верификация работы агента, тестирование, ревью, выбор моделей, SDD-workflow, проектирование навыков, рабочая память агента, безопасность git.
...
Навык `ai-edt-tools` в этом наборе - каталог этих инструментов и типовых сценариев: что вызывать под
...
Навык `ai-edt-tools` и правила написаны под **AI-EDT**: ключ сервера `ai-edt`, инструменты свернуты
