...
<tr><td><code>1c-code-review</code></td><td>Ревью BSL по каталогу дефектов: карточки с триггером, законной формой и важностью (Critical/Major/Minor), генерируемый индекс, отчет с идентификаторами находок и ключом локации</td></tr>
...
| `1c-defect-catalog-spec.md` | Спецификация каталога дефектов: карточки, реестр идентификаторов, фикстуры, генерация индекса |
