...
**29 правил** - стандарты кода BSL, антипаттерны, оптимизация запросов, паттерны расширений, генерация форм, требования EDT, БСП API и переиспользование БСП, права ролей, прямой запрос в отчётах, грабли экспорта EDT, безопасная запись BSL-модулей, Python-first интеграции, двухпроходный СКД, верификация работы агента, тестирование, ревью, выбор моделей, SDD-workflow.
