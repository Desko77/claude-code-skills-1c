...
**80 скилов** для работы с конфигурациями, расширениями, обработками, формами, макетами, запросами, ролями, подсистемами, базами данных, веб-тестированием, диагностикой и управлением сессиями 1С.

**18 правил** — стандарты кода BSL, антипаттерны, оптимизация запросов, паттерны расширений, тестирование, ревью, валидация кода, архитектура.
...
| Python 3.8+ | Нет | `v8unpack-cf`, `check-uuid`, `img-grid-analysis`, `1c-web-test` |
...
| [RLM для Claude Code](https://github.com/rand/rlm-claude-code) | Нет | Рекурсивная декомпозиция задач, оркестрация моделей, память между сессиями |
...
| Скил | Описание |
|------|----------|
| `1c-techlog` | Технологический журнал: настройка logcfg.xml, захват событий, анализ логов |

### Управление сессиями и проектами

| Скил | Описание |
|------|----------|
| `session-save` | Сохранение и восстановление контекста рабочей сессии |
| `1c-project-init` | Инициализация или обогащение 1С-проекта скилами Claude Code |
...
| `yaxunit-advanced.md` | Расширенные паттерны YaXUnit: именование, ассерты, генерация данных |
| `bsl-validation-workflow.md` | Workflow валидации BSL: порядок проверок до и после написания кода |
| `performance-optimization.md` | Workflow оптимизации производительности: поиск и исправление hot spots |
| `architecture-review.md` | Архитектурное ревью: чеклист, формат отчёта, red flags |
...
| `deploy-and-test.md` | Деплой конфигурации из XML и запуск тестов |
