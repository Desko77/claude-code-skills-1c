...
Подробные таблицы прав для каждого типа объекта — в `skills/1c-role-compile/dsl-reference.md`.
...
DSL принимает русские имена типов и прав, транслируя их в английские. Полные таблицы соответствий — в `skills/1c-role-compile/dsl-reference.md`.
