...
Агенты, хуки и инструменты набора (`agents/`, `hooks/`, `tools/`) ставятся не копированием, а
исполняемым установщиком из корня репозитория - он ведет манифест установленных файлов и не
