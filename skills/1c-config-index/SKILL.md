...
Поиск идет по подстроке имени без учета регистра. Порядок задан посимвольным сравнением, а не
языковым: локали у портов разные, и на кириллице они разошлись бы.
