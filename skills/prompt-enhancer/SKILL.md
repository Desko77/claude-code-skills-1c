...
> Проанализируй все типовые объекты конфигурации и подготовь список тех, в которых присутствуют нетиповые реквизиты. Изучи формы элементов этих объектов. Добавь в каждую форму новую вкладку "Доп. реквизиты Орг" последней по порядку. Перенеси на вкладку все нетиповые реквизиты, кроме случая, когда единственный нетиповой реквизит это Орг_КодИсточника77 (тогда изменения не вносятся). Для каждого объекта укажи:
>
