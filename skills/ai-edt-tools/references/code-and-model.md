...
|---|---|---|
| `get_content_assist` | Чтение | Возвращает подсказки EDT и сведения о типах в позиции BSL. Пакет позиций одним вызовом: `positions` - массив объектов со своими `filePath` (по умолчанию верхнеуровневый), `line`, `column`; сбойная позиция отвечает своей ошибкой и не останавливает остальные. |
