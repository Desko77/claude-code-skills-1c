...
| `stderrNotContains` | Строка или массив строк — ни одной не должно быть в stderr. Нужен там, где неверное в тексте не видно: CRLF вместо LF на сравнении строк неотличим |
